...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.kh69coin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.kh69cointools.com", true);
        vSeeds.emplace_back("dnsseed.kh69coinpool.org", true);
